...
Tu tarea es extraer TODOS los datos del formulario E-14 con MÁXIMA PRECISIÓN, generando un payload estructurado para procesamiento automatizado.
...
- Si ves escrito "0 0 3" en las 3 casillas → el número es 3
- Si ves "- - -" o casillas vacías → el número es 0

=== CÓMO IDENTIFICAR CANDIDATOS ===

En el E-14 de PRESIDENCIA, los candidatos aparecen en filas con:
- Logo del partido (izquierda)
- Nombre del partido y candidato (centro)
- Casillas de votación (derecha) ← AQUÍ ESTÁN LOS VOTOS

Lee CADA FILA de arriba hacia abajo y extrae el número de votos de la columna derecha.

=== TIPOS DE FORMULARIOS E-14 ===
1. SIMPLE (1-2 páginas): Presidencia, Gobernación, Alcaldía
   - Cada fila es un CANDIDATE individual con sus votos

2. MULTI-PÁGINA (3-9 páginas): Cámara, Senado, Asamblea, Concejo
   - Partidos con listas de candidatos
...
- "***" (triple asterisco): MUY DUDOSO, NO asignes valor
...
1. NO CONFUNDAS dígitos similares:
   ...
   - "3" vs "8" - El 3 tiene dos curvas abiertas, el 8 tiene dos círculos
   - "0" vs "6" - El 0 es ovalado cerrado, el 6 tiene curva inferior

2. Lee de IZQUIERDA a DERECHA las 3 casillas: [C][D][U]
   - El número final es: C×100 + D×10 + U

3. VERIFICA que la suma de votos sea coherente con el total

4. Si un dígito es ambiguo, indica confidence bajo (< 0.7) y needs_review=true
...
def build_presidential_prompt(pages_count: int) -> str:
    """Prompt especializado para E-14 de PRESIDENCIA."""
    return f"""TAREA: Extrae los datos de este formulario E-14 de elección PRESIDENCIAL colombiana.

INSTRUCCIONES CRÍTICAS PARA LEER LOS VOTOS:

1. El formulario tiene una TABLA con filas de candidatos
2. Cada fila tiene: [LOGO] [PARTIDO/CANDIDATO] [CASILLAS DE VOTOS]
3. Las CASILLAS DE VOTOS están a la DERECHA de cada fila
4. Cada casilla de votos tiene 3 espacios: [C][D][U] = Centenas, Decenas, Unidades
5. LEE los 3 dígitos y calcula: número = C×100 + D×10 + U

CÓMO LEER NÚMEROS MANUSCRITOS:
- "0 4 8" → 48
- "1 3 6" → 136
- "0 2 5" → 25
- "0 0 1" → 1
...
LEE CADA CANDIDATO EN ORDEN (de arriba hacia abajo en la imagen):
- Primer candidato visible → CANDIDATE_01
- Segundo candidato visible → CANDIDATE_02
- etc.

Incluye el NOMBRE del candidato que ves en la imagen junto a cada número.

Responde con este JSON (reemplaza XXX con los valores REALES que lees):

{{
  "header": {{
    "election_date": "YYYY-MM-DD",
    "election_label": "texto de elección visible",
    "corporacion": "PRESIDENCIA",
    "dept_code": "código depto",
    "dept_name": "nombre depto",
    "muni_code": "código muni",
    "muni_name": "nombre muni",
    "zone_code": "zona",
    "station_code": "puesto",
    "table_number": número_mesa,
    "copy_type": "DELEGADOS|CLAVEROS|TRANSMISION"
  }},
  "nivelacion": {{
    "total_sufragantes_e11": XXX,
    "total_votos_urna": XXX,
    "confidence_sufragantes": 0.95,
    "confidence_urna": 0.95
  }},
  "ocr_fields": [
    {{"field_key": "TOTAL_SUFRAGANTES_E11", "page_no": 1, "value_int": XXX, "raw_text": "dígitos leídos", "confidence": 0.95, "needs_review": false}},
    {{"field_key": "TOTAL_VOTOS_URNA", "page_no": 1, "value_int": XXX, "raw_text": "dígitos leídos", "confidence": 0.95, "needs_review": false}},
    {{"field_key": "CANDIDATE_01", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0001", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 1, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "CANDIDATE_02", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0002", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 2, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "CANDIDATE_03", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0003", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 3, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "CANDIDATE_04", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0004", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 4, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "CANDIDATE_05", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0005", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 5, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "CANDIDATE_06", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0006", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 6, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "CANDIDATE_07", "page_no": 1, "ballot_option_type": "CANDIDATE", "political_group_code": "0007", "political_group_name": "NOMBRE PARTIDO", "candidate_ordinal": 7, "candidate_name": "NOMBRE CANDIDATO", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "VOTOS_EN_BLANCO", "page_no": 1, "ballot_option_type": "BLANK", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "VOTOS_NULOS", "page_no": 1, "ballot_option_type": "NULL", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "VOTOS_NO_MARCADOS", "page_no": 1, "ballot_option_type": "UNMARKED", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.9, "needs_review": false}},
    {{"field_key": "TOTAL_VOTOS_MESA", "page_no": 1, "ballot_option_type": "TOTAL", "value_int": XXX, "raw_text": "dígitos", "confidence": 0.95, "needs_review": false}}
  ],
  "metadata": {{
    "total_pages": {pages_count},
    "pages_with_data": 1,
    ...
    "notes": "Extracción E-14 Presidencial"
  }}
}}

RECUERDA:
- Lee los NÚMEROS REALES de la imagen, no inventes valores
- Incluye los NOMBRES REALES de los candidatos que ves
- Si un candidato no tiene votos (vacío o guiones), value_int = 0
- La suma de todos los votos debe ser cercana al TOTAL"""
...
def build_extraction_prompt_v2(pages_count: int, corporacion_hint: Optional[str] = None) -> str:
    ...
    # Para Presidencia, usar prompt especializado
    if corporacion_hint == 'PRESIDENCIA' or (pages_count <= 2 and corporacion_hint is None):
        # Si es 1-2 páginas sin hint, podría ser presidencia - usar prompt especializado
        if pages_count <= 2:
            return build_presidential_prompt(pages_count)
...
class E14OCRService:
    ...
    def __init__(self):
        ...
        # Usar Claude Opus 4 para mejor capacidad de visión en OCR
        self.model = 'claude-opus-4-20250514'
        self.base_url = "https://api.anthropic.com/v1/messages"
        self.max_tokens = 32000  # Opus puede manejar más tokens
        self.timeout = 600  # 10 minutos para Opus que es más lento pero preciso
    ...
    def _pdf_to_images(self, pdf_data: bytes) -> List[str]:
        ...
        1. PDF → Imagen con alta resolución
        2. Preprocesamiento: contraste, brillo, deskew, limpieza
        ...
        try:
            ...
            # 1. Convertir PDF a imágenes PIL con resolución óptima
            pil_images = convert_from_bytes(
                pdf_data,
                dpi=200,  # Máximo sin exceder 8000px
                fmt='PNG'
            )

            base64_images = []
            for img in pil_images:
                # 2. Preprocesamiento de imagen (pipeline TySE)
    ...
    def _preprocess_image(self, img: 'Image.Image') -> 'Image.Image':
        ...
        # 2. Ajuste de contraste (aumentar para dígitos manuscritos)
        enhancer = ImageEnhance.Contrast(img)
        img = enhancer.enhance(1.3)  # 30% más contraste

        # 3. Ajuste de brillo (ligeramente más brillante)
        enhancer = ImageEnhance.Brightness(img)
        img = enhancer.enhance(1.1)  # 10% más brillo

        # 4. Sharpening para definir bordes de dígitos
        enhancer = ImageEnhance.Sharpness(img)
        img = enhancer.enhance(1.5)  # 50% más nitidez

        # 5. Filtro de mejora de bordes (opcional, ayuda con manuscritos)
